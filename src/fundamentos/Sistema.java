...
public class Sistema {
	...
	/***
	 * Método principal da classe para realizar testes na conversão entre
	 * listas e arrays e vice-versa.
	 * @param args String[]
	 */
...
//		imprimirConteudo(lisPessoas);
		...
		/*
		 * Para transformar uma lista em um array podemos utilizar um método da interface List e
		 * implementado por ArrayList, que é a classe base. Além disso esse método retorna normalmente um
		 * array de objetos; portanto precisamos passar como parêmetro o tipo de retorno
		 * desejado para que ele realize a conversão.
		 */
		 ...
		 * precisaremos utilizar o tamanho total da lista, pois o array tem tamanho fixo.
		 */
	...
	/***
	 * Método para encurtar a linha de comando para impressão.
	 * Imprime um único valor.
	 * @param s String
	 */
	...
	/***
	 * Método para imprimir todo o conteúdo de um array.
	 * Recebe como parametro um array de strings.
	 * @param arr String[]
	 */
	...
	/***
	 * Método para imprimir todo conteúdo de uma lista.
	 * Recebe como parametro um objeto do tipo List.
	 * @param l List
	 */
